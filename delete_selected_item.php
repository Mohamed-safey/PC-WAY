...
$msg="<p class='sucss'>item Deleted Successfully</p>";
...
<h1 class="main_title">Confrim DELETE</h1>

<h3 class="sub_title">Delete Item</h3>
...
<form method="post" action="done_item_delete.php">
...
<button class="btn_big" style="margin-top:35px;" name="item_update">DELETE</button>
